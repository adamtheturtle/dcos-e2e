...
from ..dcos_test_utils import diagnostics, jobs, marathon, package, helpers
...
class DcosApiSession(
    ...
    def login_default_user(self):
        ...
        r = self.post(
            "/acs/api/v1/auth/login", json=self.auth_user.credentials, auth=None
        )
        r.raise_for_status()
    ...
    def _wait_for_metronome(self):
        ...
        assert (
            r.status_code == 200
        ), "Expecting status code 200 for Metronome but got {} with body {}".format(
    ...
    def exhibitor(self):
        ...
        if self.exhibitor_admin_password is None:
            ...
            default_url = helpers.Url.from_string(
    ...
    def health(self):
        ...
        return diagnostics.Diagnostics(
            health_url, self.masters, self.all_slaves, session=self.copy().session
        )
    ...
    def metronome_one_off(
        self, job_definition: dict, timeout: int = 300, ignore_failures: bool = False
    ) -> None:
    ...
    def mesos_sandbox_directory(
        self, slave_id: str, framework_id: str, task_id: str
    ) -> str:
        ...
        try:
            ...
            raise Exception(
                "Framework {} not found on agent {}".format(framework_id, slave_id)
            )
    ...
    def mesos_sandbox_file(
        self, slave_id: str, framework_id: str, task_id: str, filename: str
    ) -> str:
        ...
        r = self.get(
            ...
            params={
                "path": self.mesos_sandbox_directory(slave_id, framework_id, task_id)
                + "/"
                + filename
            },
        )
    ...
    def mesos_pod_sandbox_directory(
        self, slave_id: str, framework_id: str, executor_id: str, task_id: str
    ) -> str:
        ...
        """
        return "{}/tasks/{}".format(
            self.mesos_sandbox_directory(slave_id, framework_id, executor_id), task_id
        )
